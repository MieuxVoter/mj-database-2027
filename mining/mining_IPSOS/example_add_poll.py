...
def add_poll_to_csv(poll_id: str, poll_type: str, nb_people: int, 
                    start_date: str, end_date: str, folder: str, population: str = "all"):
    """
...
def main():
    ...
    result = subprocess.run(
        ["python", "mining/mining_IPSOS/extract_ipsos_from_html.py", str(source_html)],
        capture_output=True,
        text=True
    )
